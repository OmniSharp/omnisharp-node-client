...
export class ObservationClientV1<T extends ClientV1> extends ObservationClientBase<T> implements OmniSharp.Events.V1 {
    ...
    @merge public get getcodeactions(): Rx.Observable<OmniSharp.Context<OmniSharp.Models.GetCodeActionRequest, OmniSharp.Models.GetCodeActionsResponse>> { throw new Error("Implemented by decorator"); }
    ...
    @merge public get runcodeaction(): Rx.Observable<OmniSharp.Context<OmniSharp.Models.RunCodeActionRequest, OmniSharp.Models.RunCodeActionResponse>> { throw new Error("Implemented by decorator"); }
...
export class AggregateClientV1<T extends ClientV1> extends CombinationClientBase<T> implements OmniSharp.Events.Aggregate.V1 {
    ...
    @aggregate public get getcodeactions(): Rx.Observable<OmniSharp.CombinationKey<OmniSharp.Context<OmniSharp.Models.GetCodeActionRequest, OmniSharp.Models.GetCodeActionsResponse>>[]> { throw new Error("Implemented by decorator"); }
    ...
    @aggregate public get runcodeaction(): Rx.Observable<OmniSharp.CombinationKey<OmniSharp.Context<OmniSharp.Models.RunCodeActionRequest, OmniSharp.Models.RunCodeActionResponse>>[]> { throw new Error("Implemented by decorator"); }
